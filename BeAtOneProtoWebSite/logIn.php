...
<body>
     ...
     <div class="navbar-header">
      ...
      <div class="navbar-collapse collapse " id="collapseNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="visibleLogIn"><a href="./logOut.php"><span class="glyphicon glyphicon-user"></span> Log out</a></li>
  ...
  <div class="col-sm-8">
  <h1 class="bigTitle">Login Page</h1>
  <form name="form1" method="post" action="runOnce.php" autocomplete="off">
    <table>
      <tr>
        <td width="78">Username</td>
        <td width="294"><input name="myusername" type="text" id="myusername" autocomplete="off"></td>
      </tr>
      <tr>
        <td>Password</td>
        <td><input name="mypassword" type="password" id="mypassword" autocomplete="off"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><input class="funButtons" type="submit" name="Submit" value="Login"></td>
      </tr>
    </table>
  </form>
  </div>
